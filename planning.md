...
- [ ] Be able to search books from the open library api, https://openlibrary.org/search.json?q=harry+potter
    ...
    - [ ] when we click the book it shows a page for it and we have a button to add to library
- [ ] develop the book library
- [ ] Be able to add this book + metadata + image to the dataset
- [ ] books state, (reading, completed, unread)
- [ ] have a flag to limit number of users to 1